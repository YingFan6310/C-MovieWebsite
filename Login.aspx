...
<div class="stars"></div>
        ...
        <div style="height: 349px; width: 646px; margin-left: 906px; margin-top: 150px">
            ...
            <asp:RequiredFieldValidator ID="rfvName" runat="server" ControlToValidate="txtName" ErrorMessage="请输入用户名！" ForeColor="White" style="font-weight: 700" Font-Underline="True"></asp:RequiredFieldValidator>
            <asp:TextBox ID="txtPassword" runat="server" Height="33px" style="margin-left: 5px; margin-top: 32px;" Width="317px" TextMode="Password" OnTextChanged="txtPassword_TextChanged"></asp:TextBox>
            <asp:RequiredFieldValidator ID="rfvPassword" runat="server" ControlToValidate="txtPassword" ErrorMessage="请输入密码！" ForeColor="White"></asp:RequiredFieldValidator>
          ...
          &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp<asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/Admin.aspx">管理员</asp:HyperLink>&nbsp&nbsp
<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/Change Password.aspx" >修改密码</asp:HyperLink>
    </div>
    </form>
