   ...
   <div class="container">
        ...
        <div class="navbar-collapse collapse" role="navigation">
          <ul class="nav navbar-nav">
            <li><a href="" target="_blank" onclick="">动作</a></li>
            <li><a href="" target="_blank" onclick="">科幻</a></li>
            <li><a href="" target="_blank" onclick="">爱情</a></li>
            <li><a href="" target="_blank" onclick="">惊悚</a></li>
...
<div class="portfolio">
    ...
    <br />
					...
					<h3><font color="#fff" size="6">动作电影</font></h3>
    ...
    <br/>
					...
					<div class="portfolio app mix_all  wow bounceIn" data-wow-delay="0.4s" data-cat="app" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper grid_box">		
							 <a href="" target="_blank" onclick=""> <img src="images/34.jpg" class="img-responsive" alt=""/> </a>
		                </div>
					</div>			
					<div class="portfolio card mix_all  wow bounceIn" data-wow-delay="0.4s" data-cat="card" style="display: inline-block; opacity: 1;">
						<div class="portfolio-wrapper grid_box">		
