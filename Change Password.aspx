<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Change Password.aspx.cs" Inherits="Default2" %>
...
<div style="height:59px; width:80px;margin-left: 50px; margin-top: 110px">
    ...
    <div  style="height: 349px; width: 646px; margin-left: 906px; margin-top: 200px;font-size: large; color: #FFFFFF;">
       <span class="auto-style4">&nbsp;&nbsp;请输入用户名</span>
        
          <asp:TextBox ID="TextBox1" runat="server" Width="260px" Font-Size="Medium" Height="32px" OnTextChanged="TextBox1_TextChanged"  ForeColor="Black"></asp:TextBox>
        
     <br />
         <br />

&nbsp;&nbsp;&nbsp;&nbsp;<span class="auto-style4">&nbsp;&nbsp; 你的旧密码</span><asp:TextBox ID="TextBox2" runat="server" Height="32px"  Width="260px" TextMode="Password" Font-Size="Medium" ForeColor="Black" OnTextChanged="TextBox2_TextChanged"></asp:TextBox>
       <br />
         <br /> 

&nbsp;&nbsp;&nbsp;&nbsp;<span class="auto-style4">&nbsp;&nbsp; 你的新密码</span><asp:TextBox ID="TextBox3" runat="server" Height="32px" Width="260px" TextMode="Password" Font-Size="Medium" ForeColor="Black"></asp:TextBox>
          <br />
          <br />  
       
       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Button1" runat="server" Height="36px" Width="100px" ForeColor="Black" Text="确定" OnClick="Button1_Click" />
    </div>
    </form>
</body>
</html>
