...
<div class="stars"></div>
    ...
    <div style="height: 477px; margin-left: 850px; margin-top: 131px; width: 999px; font-size: x-large; color: #FFFFFF;">
        <span class="auto-style4">&nbsp;&nbsp; 用户名</span>
        <asp:TextBox ID="txtName" runat="server"  Height="32px" Width="286px" style="margin-left: 0px; margin-top: 23px;" Font-Size="Medium" ForeColor="Black"></asp:TextBox>


        <asp:RequiredFieldValidator ID="rfvName" runat="server" ControlToValidate="txtName" Display="Dynamic" ErrorMessage="请输入用户名"   SetFocusOnError="True" Font-Size="Large"></asp:RequiredFieldValidator>
       
        &nbsp;
        <br />

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 密码<asp:TextBox ID="txtPassword" runat="server" Height="32px" OnTextChanged="TextBox1_TextChanged1" style="margin-left: 0px; margin-top: 24px;" Width="286px" TextMode="Password" Font-Size="Medium" ForeColor="Black"></asp:TextBox>
        <asp:RequiredFieldValidator ID="rfvPassword" runat="server" ControlToValidate="txtPassword" Display="Dynamic" ErrorMessage="请输入密码" SetFocusOnError="True" CssClass="auto-style1" Font-Size="Large"></asp:RequiredFieldValidator>
        <br class="auto-style1" />



        <span class="auto-style1">确认密码</span><asp:TextBox ID="txtPasswordAgain" runat="server" style="margin-top: 16px; margin-left: 0px;" Height="32px" OnTextChanged="TextBox1_TextChanged2" Width="286px" TextMode="Password" Font-Size="Medium" ForeColor="Black"></asp:TextBox>
       

         
         <asp:CompareValidator ID="cvPassword" runat="server" ControlToValidate="txtPasswordAgain" Display="Dynamic" ErrorMessage="两次输入密码不同" Font-Size="Large" SetFocusOnError="True" ControlToCompare="txtPassword"></asp:CompareValidator>
        <br />
        <br />
        <asp:Button ID="btnSubmit" runat="server" Height="36px" style="margin-left: 188px" Text="确定" OnClick="Button1_Click" Width="104px" BackColor="#CCCCCC" Font-Size="Medium" ForeColor="Black" />
    </div>
    </form>
